...
public class TestConstants {
    ...
    public static final String USERNAME = "Brad.Pitt";
    public static String PASSWORD = "12345";
    public static TrainingType SPECIALIZATION = new TrainingType("RESISTANCE");
    public static final String TRAINEE_USERNAME = "Olga.Kurilenko";
    public static final String TRAINER_USERNAME = "Monica.Dobs";
