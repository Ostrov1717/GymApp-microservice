...
public class TrainingDurationService {
    ...
    public TrainerWorkingHoursDTO getTrainingSummaryByUsername(String username) {
        ...
        return new TrainerWorkingHoursDTO(trainer.getUsername(), trainer.getFirstName(), trainer.getLastName(), trainer.isActive(), trainingsDuration);
    }
}
